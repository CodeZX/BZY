...
@interface MyCollectViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,MusicItemCellDelegate>
...
//                          };
    [[AFHTTPSessionManager manager] POST:@"http://45.63.35.70:8080/tj_audio/show_collect" parameters:nil progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView {
    ...
    NSAttributedString *attString = [[NSAttributedString alloc]initWithString:@"No collection at this stage"];
    return attString;
}

- (UIImage *)imageForEmptyDataSet:(UIScrollView *)scrollView {
    
    return [UIImage imageNamed:@"你还没有收藏职位哦!"];
}
